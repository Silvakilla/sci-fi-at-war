	...
	{
		{
			...
			,"Imperial_Light_Scout_Squad = 1"
			,"Imperial_Heavy_Scout_Squad = 1"
		},
		{
			"RebelForce"
			,"DenyHeroAttach"
			,"Rebel_Infantry_Squad = 2"
			,"Rebel_Tank_Buster_Squad = 2"
			,"Rebel_Light_Tank_Brigade = 1"
		}
	}
...
function ReserveForce_Thread()	
	...
	while (GetCurrentTime() - wait_start_time < wait_duration) and (EvaluatePerception("Needs_Magic_Ground_Defense", PlayerObject, Target) == 0.0) do
		Sleep(1)
	end
