...
function Definitions()
	...
	{
		"BaseForce",
		"E_Ground_Barracks | R_Ground_Barracks | E_Ground_Light_Vehicle_Factory | R_Ground_Light_Vehicle_Factory | E_Ground_Research_Facility | R_Ground_Research_Facility | Communications_Array_E | Communications_Array_R | E_Ground_Heavy_Vehicle_Factory | R_Ground_Heavy_Vehicle_Factory | E_Ground_Officer_Academy | R_Ground_Officer_Academy | E_Ground_Advanced_Vehicle_Factory | Power_Generator_E | Power_Generator_R = 1"
	}
	}
