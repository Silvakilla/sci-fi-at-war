...
function Definitions()
	...
	{
		"BaseForce",
		"E_Ground_Heavy_Vehicle_Factory | R_Ground_Heavy_Vehicle_Factory | Empire_UNSC_Ground_Vehicle_Factory | Rebel_UNSC_Ground_Vehicle_Factory | Empire_COV_Ground_Vehicle_Factory | Rebel_COV_Ground_Vehicle_Factory = 1"
	}
	}
