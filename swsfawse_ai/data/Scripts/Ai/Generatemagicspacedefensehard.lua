	...
	{
		{
			"EmpireForce"
			,"DenyHeroAttach"
			,"Victory_Destroyer_Class_II = 2"
			,"Star_Destroyer_Class_I = 1"
		},
		{
			"RebelForce"
			,"DenyHeroAttach"
...
function ReserveForce_Thread()		
	...
	while (GetCurrentTime() - wait_start_time < wait_duration) and (EvaluatePerception("Needs_Magic_Space_Defense", PlayerObject, Target) == 0.0) do
		Sleep(1)
	end
