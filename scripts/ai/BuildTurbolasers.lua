...
function Definitions()	
	...
	TaskForce = {
		{
			"StructureForce",
			"E_Galactic_Turbolaser_Tower_Defenses | R_Galactic_Turbolaser_Tower_Defenses | Empire_Light_Ship_Yard | Rebel_Light_Ship_Yard | Empire_Medium_Ship_Yard | Rebel_Medium_Ship_Yard | Empire_Heavy_Ship_Yard | Rebel_Heavy_Ship_Yard = 1"
		}
	}
end
